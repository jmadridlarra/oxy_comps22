function main() {
    //import { mat4 } from 'C:/Users/joaqu/OneDrive/Desktop/comps/WebGL/toji-gl-matrix-8962b2e/dist/gl-matrix-min.js';
...
// Draw the scene.
//
function drawScene(gl, programInfo, n) {
...
function circleCreation(){
    // actual math for defining a circle
    var vertices = [],
        vertCount = 2;
    var colors = [];
    ...
    return [vertices, colors, n]
}
// creates the circles for level 1
function drawCircles(gl, programInfo) {
    // Now pass the list of positions into WebGL to build the
    // shape. We do this by creating a Float32Array from the
    // JavaScript array, then use it to fill the current buffer.
...
function makeShapes(gl, programInfo){
    ...
    var n = drawCircles(gl, programInfo);
    var n = 10
    initBuffers(gl, positions, colors);

    // Draw the scene
    drawScene(gl, programInfo, n);
    }
main();
  //window.onload = main;
